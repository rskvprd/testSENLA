...
public class MainDynamic {
    public static void main(String[] args) {
        int[] weights = {3, 4, 5, 8, 9}; //объемы предметов Wi
        int[] prices = {1, 6, 4, 7, 6}; //ценность предметов Pi

        int count = weights.length; // колличество предметов N
        int maxWeight = 13; //объем сейфа W
